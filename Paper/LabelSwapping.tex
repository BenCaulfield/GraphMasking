...
\begin{figure}[H]
	\begin{algorithmic}
		...
		\Require {Set of Adjacency Groups $A$}
		\Ensure {Ordered List of Adjacency Groups $A'$}
...
\begin{thm}  Applying a \emph{swapping} to a graph, G, will yield a graph, G', with the same k-Neighborhood graph as G.
\end{thm}
\begin{proof}
